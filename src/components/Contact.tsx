        ...
        <div className="lg:col-span-7">
          <SpotlightCard className="p-8" glowColor="rgba(255, 255, 255, 0.02)">
            ...
            <p className="text-neutral-400 mb-8 max-w-md mx-auto">
              I am open to internships, collaborations, and exciting opportunities.
              Feel free to reach out through email, phone, or LinkedIn.
            </p>

              <a
                href="mailto:jayavaruput@gmail.com"
                className="inline-block px-8 py-3 rounded-lg bg-white text-black font-semibold hover:bg-neutral-200 transition-all"
              >
                Email Me
              </a>
</div>
